pipeline {
	...
	environment{
		PROJECT_TITLE = "Astemes LUnit Global Fixture"
		REPO_URL = "https://github.com/astemes/astemes-lunit-global-fixture"
		AUTHOR = "Anton Sundqvist"
		INITIAL_RELEASE = 2024
		LV_PROJECT_PATH = "source\\LUnit Global Fixture.lvproj"
		LV_BUILD_SPEC = "Global Fixture"
		LV_VIPB_PATH = "source\\LUnit Global Fixture.vipb"
		LV_VERSION = "20.0"
	}
	stages {
		stage('Initialize') {
